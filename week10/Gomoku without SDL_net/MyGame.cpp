...
int MyGame::get_winner(GameContext& context) {
  for (int i = 0; i < board_vector.size(); i++) {
    for (int j = 0; j < board_vector[i].size(); j++) {
      if (board_vector[i][j] != 0) {
        if (i < 16 && board_vector[i][j] == board_vector[i + 1][j] && board_vector[i][j] == board_vector[i + 2][j] && board_vector[i][j] == board_vector[i + 3][j] && board_vector[i][j] == board_vector[i + 4][j]) {
          draw_horisontal_line_to_cross_the_winner_five(context, i, j);
          return board_vector[i][j];
        }
        if (j < 16 && board_vector[i][j] == board_vector[i][j + 1] && board_vector[i][j] == board_vector[i][j + 2] && board_vector[i][j] == board_vector[i][j + 3] && board_vector[i][j] == board_vector[i][j + 4]) {
          draw_vertical_line_to_cross_the_winner_five(context, i, j);
          return board_vector[i][j];
        }
        if (i < 16 && j < 16 && board_vector[i][j] == board_vector[i + 1][j + 1] && board_vector[i][j] == board_vector[i + 2][j + 2] && board_vector[i][j] == board_vector[i + 3][j + 3] && board_vector[i][j] == board_vector[i + 4][j + 4]) {
          draw_diagonal_line_to_right_to_cross_the_winner_five(context, i, j);
          return board_vector[i][j];
        }
        if (i > 4 && j < 16 && board_vector[i][j] == board_vector[i - 1][j + 1] && board_vector[i][j] == board_vector[i - 2][j + 2] && board_vector[i][j] == board_vector[i - 3][j + 3] && board_vector[i][j] == board_vector[i - 4][j + 4]) {
